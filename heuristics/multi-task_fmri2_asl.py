...
def AttachToProject():
    ...
    return [object, rhyme, scenemem, sentence, wordgen]
...
MetadataExtras = {
   ...
   "PulseSequenceType": "3D_SPIRAL",
     ...
     binder_run1: {
     "TaskName": "Binder Semantic Decision"},
     binder_run2: {
     "TaskName": "Binder Semantic Decision"},
     object_run1: {
     "TaskName": "Object Naming"},
     object_run2: {
     "TaskName": "Object Naming"},
     rhyme_run1: {
     "TaskName": "Rhyme Matching"},
     rhyme_run2: {
     "TaskName": "Rhyme Matching"},
     scenemem_run1: {
     "TaskName": "Scene Memory"},
     scenemem_run2: {
     "TaskName": "Scene Memory"},
     sentence_run1: {
     "TaskName": "Sentence Completion"},
     sentence_run2: {
     "TaskName": "Sentence Completion"},
     verbgen_run1: {
     "TaskName": "Verb Generation"},
     verbgen_run2: {
     "TaskName": "Verb Generation"},
     wordgen_run1: {
     "TaskName": "Word Generation"},
     wordgen_run2: {
     "TaskName": "Word Generation"},
}
