...
object_run2 = create_key(
    'sub-{subject}/ses-{session}/func/sub-{subject}_ses-{session}_task-object_run-02_bold')
rhyme_run1 = create_key(
    'sub-{subject}/ses-{session}/func/sub-{subject}_ses-{session}_task-rhyme_run-01_bold')
rhyme_run2 = create_key(
    'sub-{subject}/ses-{session}/func/sub-{subject}_ses-{session}_task-rhyme_run-02_bold')
scenemem_run1 = create_key(
    'sub-{subject}/ses-{session}/func/sub-{subject}_ses-{session}_task-scenemem_run-01_bold')
scenemem_run2 = create_key(
    'sub-{subject}/ses-{session}/func/sub-{subject}_ses-{session}_task-scenemem_run-02_bold')
sentence_run1 = create_key(
    'sub-{subject}/ses-{session}/func/sub-{subject}_ses-{session}_task-sentence_run-01_bold')
sentence_run2 = create_key(
    'sub-{subject}/ses-{session}/func/sub-{subject}_ses-{session}_task-sentence_run-02_bold')
wordgen_run1 = create_key(
    'sub-{subject}/ses-{session}/func/sub-{subject}_ses-{session}_task-wordgen_run-01_bold')
wordgen_run2 = create_key(
    'sub-{subject}/ses-{session}/func/sub-{subject}_ses-{session}_task-wordgen_run-02_bold')
binder_run1 = create_key(
    'sub-{subject}/ses-{session}/func/sub-{subject}_ses-{session}_task-binder_run-01_bold')
binder_run2 = create_key(
    'sub-{subject}/ses-{session}/func/sub-{subject}_ses-{session}_task-binder_run-02_bold')
verbgen_run1 = create_key(
    'sub-{subject}/ses-{session}/func/sub-{subject}_ses-{session}_task-verbgen_run-01_bold')
verbgen_run2 = create_key(
    'sub-{subject}/ses-{session}/func/sub-{subject}_ses-{session}_task-verbgen_run-02_bold')
rest = create_key(
...
IntendedFor = {
    b0_phase: [
    'ses-{session}/func/sub-{subject}_ses-{session}_task-object_run-01_bold.nii.gz',
    'ses-{session}/func/sub-{subject}_ses-{session}_task-object_run-02_bold.nii.gz',
    'ses-{session}/func/sub-{subject}_ses-{session}_task-rhyme_run-01_bold.nii.gz',
    'ses-{session}/func/sub-{subject}_ses-{session}_task-rhyme_run-02_bold.nii.gz',
    'ses-{session}/func/sub-{subject}_ses-{session}_task-scenemem_run-01_bold.nii.gz',
    'ses-{session}/func/sub-{subject}_ses-{session}_task-scenemem_run-02_bold.nii.gz',
    'ses-{session}/func/sub-{subject}_ses-{session}_task-sentence_run-01_bold.nii.gz',
    'ses-{session}/func/sub-{subject}_ses-{session}_task-sentence_run-02_bold.nii.gz',
    'ses-{session}/func/sub-{subject}_ses-{session}_task-wordgen_run-01_bold.nii.gz',
    'ses-{session}/func/sub-{subject}_ses-{session}_task-wordgen_run-02_bold.nii.gz',
    'ses-{session}/func/sub-{subject}_ses-{session}_task-binder_run-01_bold.nii.gz',
    'ses-{session}/func/sub-{subject}_ses-{session}_task-binder_run-02_bold.nii.gz',
    'ses-{session}/func/sub-{subject}_ses-{session}_task-verbgen_run-01_bold.nii.gz',
